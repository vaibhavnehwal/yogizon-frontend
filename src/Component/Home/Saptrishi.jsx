...
function Saptrishi() {
  ...
  return (
    <>
      <div className="flex justify-center items-center mt-[10em] py-[40px] bg-[black] hs-tooltip [--trigger:hover]">
        <svg
          width="900"
          height="495"
          viewBox="0 0 339 195"
          ...
          className="block text-center hs-tooltip-toggle"
        >
          <line
            x1="157.713"
            y1="93.5907"
        ...
        <div
          className="hs-tooltip-content hs-tooltip-shown:opacity-100 hs-tooltip-shown:visible hidden opacity-0 transition-opacity inline-block absolute invisible z-10 max-w-xs bg-white border border-gray-100 text-start rounded-lg shadow-md"
          role="tooltip"
        >
          ...
          <div className="py-3 px-4 text-sm text-gray-600">
            ...
            <p>
              This is a popover body with supporting text below as a natural
              lead-in to additional content.
            </p>
            <dl className="mt-3">
              <dt className="font-bold pt-3 first:pt-0">
                Assigned to:
              </dt>
              <dd className="text-gray-600">Mark Welson</dd>
              <dt className="font-bold pt-3 first:pt-0">
                Due:
              </dt>
